{{-- Halaman form edit departemen — hanya dapat diakses oleh HR --}}
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form dikirim ke DepartmentController@update via POST dengan method spoofing PUT --}}
                    <form action="{{ route('departments.update', $department->id) }}" method="POST">
                        @csrf
                        @method('PUT') {{-- Spoofing agar Laravel mengenali ini sebagai request PUT --}}

                        <div class="mb-3">
                            <label for="" class="form-label">Name</label>
                            {{-- old(): tampilkan nilai lama jika validasi gagal; $department->name: nilai dari database --}}
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Tandai opsi yang sesuai dengan status departemen saat ini --}}
