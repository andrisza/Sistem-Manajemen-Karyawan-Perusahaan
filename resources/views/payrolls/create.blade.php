{{-- Halaman form tambah data payroll baru — hanya HR yang dapat mengakses --}}
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form dikirim ke PayrollController@store --}}
                    {{-- net_salary dihitung otomatis di controller: salary + bonuses - deductions --}}
                    <form action="{{ route('payrolls.store') }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label for="" class="form-label">Employee</label>
                            {{-- Dropdown pilih karyawan yang akan dibayar --}}
