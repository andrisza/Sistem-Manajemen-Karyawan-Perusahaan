{{-- Halaman form edit jabatan — hanya dapat diakses oleh HR --}}
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form dikirim ke RoleController@update via POST dengan method spoofing PUT --}}
                    <form action="{{ route('roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Tampilkan nilai saat ini dari database (atau nilai lama jika validasi gagal) --}}
