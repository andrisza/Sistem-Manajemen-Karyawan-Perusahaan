{{-- Halaman form tambah tugas baru — hanya HR yang dapat membuat tugas --}}
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form dikirim ke TaskController@store --}}
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Dropdown pilih karyawan yang akan diberi tugas (assigned_to) --}}
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control  @error('status') is-invalid @enderror">
                                ...
                                <option value="done">On Progress</option>
                            </select>
                            @error('due_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
