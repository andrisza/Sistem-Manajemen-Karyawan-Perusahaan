{{-- Halaman form edit tugas — hanya HR yang dapat mengedit tugas --}}
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form dikirim ke TaskController@update via PUT --}}
                    <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Tandai karyawan yang saat ini bertanggung jawab atas tugas ini --}}
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Tandai status yang saat ini dimiliki tugas --}}
