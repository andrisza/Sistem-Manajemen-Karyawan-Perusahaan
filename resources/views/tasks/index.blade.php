                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($task->status == 'pending')
                                <span class="text-warning">Pending</span>      @elseif($task->status == 'on progress')
                                <span class="text-primary">On Progress</span>  @elseif($task->status == 'done')
                                <span class="text-success">Done</span>         @else
                                <span class="text-secondary">{{ $task->status }}</span> @endif
                        </td>
